...
type StaffTeachersTableProps = {
  readonly rows: ReadonlyArray<Row>;
};

export function StaffTeachersTable({ rows }: StaffTeachersTableProps) {
  ...
  const filtered = useMemo(() => {
    ...
    return rows.filter(({ teacher, user }) => {
      ...
      return (
        ...
        teacher.subjectProficiency.some((s) =>
                ...
                <TableRow key={teacher.userId}>
                  ...
                  <TableCell className="text-right">
                    <Badge variant="secondary" className="font-mono">
                      {teacher.assignedCourseIds.length}
                    </Badge>
                  </TableCell>
                  <TableCell className="text-right">
                    <Badge
...
export default StaffTeachersTable;
